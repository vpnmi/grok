...
Examples:
    ...
    # Export step-by-step trace for debugging / secondary development
    ...
    parser.add_argument(
        "--trace",
        type=str,
        default=os.getenv("PHONE_AGENT_TRACE_PATH"),
        help="Export execution trace to a JSONL file (optional)",
    )
    parser.add_argument(
        "--trace-no-screenshots",
        action="store_true",
        help="Do not save screenshots when trace is enabled",
    )
    parser.add_argument(
        "--trace-screenshot-dir",
        type=str,
        default=os.getenv("PHONE_AGENT_TRACE_SCREENSHOT_DIR"),
